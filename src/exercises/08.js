...
class Toggle extends React.Component {
  ...
  internalSetState = (updater, callback) => {
    this.setState(prevState => {
      const changes = typeof updater === 'function' ? updater(prevState) : updater;

      const reducedChanges = this.props.stateReducer(prevState, changes) || {};
  ...
  reset = () => this.internalSetState(this.initialState, () => this.props.onReset(this.state.on));
  toggle = () =>
