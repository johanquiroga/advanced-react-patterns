...
test('renders a toggle component', () => {
  const { toggleButton, toggle, container, rootInstance } = renderToggle(<Usage />);
  ...
  try {
    expect(subtitleWrapperFiberNode.type.render.displayName).toMatch('withToggle(Subtitle)');
  } catch (error) {
    const helpfulMessage = chalk.red(
...
/*
http://ws.kcd.im/?ws=react%20patterns&e=12&em=johan.c.quiroga@gmail.com
*/
